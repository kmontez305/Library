package com.example.library.ui.theme.data
...
//import androidx.ui.theme.navigation.NavHostController
import com.example.library.ui.theme.navigation.ROUTE_VIEW_UPLOAD

import com.example.library.ui.theme.Models.Upload
...
class ProductViewModel(var navController: NavHostController, var context: Context) {
    ...
    fun saveProduct(bookName: String, bookQuantity: String,bookPrice: String) {
        var id = System.currentTimeMillis().toString()
        var productData = Product(bookName,bookQuantity,bookPrice, id)
